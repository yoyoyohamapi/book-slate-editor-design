...
<p align="center">
  <img src="./statics/ot-sys-3-1.png" width="800" />
</p>
...
<p align="center">
  <img src="./statics/ot-sys-3-2.png" width="800" />
</p>
在客户端 A，提交了 A0(0)，服务端检测到冲突，执行 OT，将获得的 A0'(1) 落库，更新服务端版本为 2，并将 A0'(1) 分发到其他客户端。
<p align="center">
  <img src="./statics/ot-sys-3-3.png" width="800" />
</p>
在客户端 A，也收到了服务端派发的 B0(0)，A 检测到冲突，基于 [A(0), A(1)] 对 B0(0) 做变换，得到 B0'(2)，更新版本为 3。
<p align="center">
  <img src="./statics/ot-sys-3-4.png" width="800" />
</p>
紧接着 A 受到了 A0'(1) 的 ACK，更新版本为 2，继续提交 A1(2)（因为客户端版本已更新为 2，所以此时提交的操作捎带的客户端版本为 2），由于服务端当前版本也是 2，因此 A1(2) 可以直接落库，服务端更新版本为 3。
<p align="center">
  <img src="./statics/ot-sys-3-5.png" width="800" />
</p>
同理，B 客户端受到 ACK 以后也更新自己的版本，
<p align="center">
  <img src="./statics/ot-sys-3-6.png" width="800" />
</p>
再收到 A1(2) 之后，能够直接应用，应用后，更新状态为 3。最终各个客户端和服务端到达了一直的版本 3：
<p align="center">
